...
#define PARA_SIGN 0x20200208 // If a new setting parameter is added, modify here and initialize the initial value in the "infoSettingsReset()" function
...
void storePara(void)
{
  ...
  wordToByte(infoSettings.auto_bed_leveling,  data + (index += 4));

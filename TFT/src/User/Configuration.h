...
#define PREHEAT_BED      {0,    56,     90,    50,     50,    90}
...
#define SPEED_Z_SLOW   1200
#define SPEED_Z_NORMAL 3600
#define SPEED_Z_FAST   5520
 ...
 */
#define TOAST_DURATION (2 * 1000)  // (MilliSeconds)  1000 MilliSeconds = 1 Second

...
//                       PLA      PETG       ABS
#define PREHEAT_BED      {52,      64,       100}
#define PREHEAT_HOTEND   {200,     236,      230}

#define HEAT_MAX_TEMP    {130,    250,       250,       250,       250,       250,       250}    //max temperature can be set
...
#define PREVENT_COLD_EXTRUSION_MINTEMP 160
